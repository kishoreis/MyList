                    ...
                    <div class="row">
                        <div class="col-10">
                            <div class="input-group form-group"  style="align-self:center;">
                                ...
                                <input type="email" class="form-control  p-3 rounded" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-10">
                            <div class="input-group  form-group"  style="align-self:center;">
                                ...
                                <input type="password" class="form-control  rounded" TextMode="Password" placeholder="password">
                            </div>
                        </div>
                    </div>
